...
<a href="{{env('APP_URL')}}">
  ...
  <div class="col-12 text-left">
    ...
    <div class="container m-auto" style="height: unset;min-height: unset;text-align: unset!important;     
    align-items: unset;
    justify-content: unset;max-width: 1000px;margin: auto">
      <div class="btn-group dropup">
        <button type="button" class="btn btn-light dropdown-toggle py-2 px-3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          اللغة - Language
        </button>
        <div class="dropdown-menu">
          <a class="dropdown-item" href="/switch_language/ar">العربية</a>
          <a class="dropdown-item" href="/switch_language/en">English</a> 
          <!-- Dropdown menu links -->
        </div>
      </div>
    </div>
